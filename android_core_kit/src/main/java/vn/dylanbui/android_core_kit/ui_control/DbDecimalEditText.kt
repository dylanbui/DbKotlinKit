...
class DbDecimalEditText : AppCompatEditText  {
    ...
    private fun obtainAttributes(attrs: AttributeSet?) {
        if (attrs != null) {
            val typedArrays = context.obtainStyledAttributes(attrs, R.styleable.DbDecimalEditText)
            try {
                isDecimal = typedArrays.getBoolean(R.styleable.DbDecimalEditText_isDecimal, false)
            } finally {
                typedArrays.recycle()
            }
        }
